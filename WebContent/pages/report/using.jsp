...
<script type="text/javascript" src="js/report/using.js"></script>
</head>
<body>
	<div>
		<form id="using_form" method="post">
			<table>
				<tr>
					<td>日期：</td>
					<td>
			...
			<a href="javascript:void(0)" onclick="using()" class="easyui-linkbutton" data-options="iconCls:'icon-large-smartart'" style="padding:5px 0px;width:100%;">
